...
class SearchOptionsActivity : AppCompatActivity() {
    ...
    private lateinit var hardCodeSearchOptions: List<SearchOptions>

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_flights)

        val title = findViewById<TextView>(R.id.titleFlights)
        ...
        val adapter = SearchSystemAdapter(hardCodeSearchOptions) { selectedFlight ->
